<!--
    This is the template for the protein calculator form
    Here are the fields that will be included in the form:
    -- Are you pregnant or nursing? - We will want a selector for yes or no
    -- Weight - We will want a selector for lbs or kgs
    -- Height - We will want a selector for inches or cm
    -- Age - We will want a selector for years
    -- Workouts - We will want a selector for the number of workouts per week
    -- Goals  
    --- Weight Loss
    --- Maintain 
    --- Muscle Mass
    ...
    <form class="protein-calculator-form">
        <div class="protein-calculator__form-group protein-calculator__form-group--radio">
            ...
            <div class="protein-calculator__inputs protein-calculator__inputs--radio">
                <input class="protein-calculator__units-measurement protein-calculator__radio" type="radio" id="imperial" name="units" <?php echo 'imperial' === $settings['system'] ? 'checked' : ''; ?>  value="imperial">
                <label for="imperial">Imperial</label>
                <input class="protein-calculator__units-measurement protein-calculator__radio" type="radio" id="metric" name="units" <?php echo 'metric' === $settings['system'] ? 'checked' : ''; ?> value="metric">
        ...
        <div class="protein-calculator__step protein-calculator__pregnant-fields">
            ...
            <div class="protein-calculator__form-group">
                ...
                <div class="protein-calculator__inputs protein-calculator__inputs--number-small">
                    <div class="protein-calculator__toggle-units <?php echo 'metric' === $settings['system'] ? 'hide' : ''; ?>">
                    ...
                    <div class="protein-calculator__toggle-units <?php echo 'imperial' === $settings['system'] ? 'hide' : ''; ?>" >
        ...
        <div class="protein-calculator__step protein-calculator__not-pregnant-fields">    
            ...
            <div class="protein-calculator__form-group">
                ...
                <div class="protein-calculator__inputs protein-calculator__inputs--select">
                    <select class="protein-calculator__active-level" name="workouts">
